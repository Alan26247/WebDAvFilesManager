...
namespace WebDav
{
    ...
    public class WebDav : IWebDav
    {
        ...
        public WebDav(WebDavClientParams @params)
        {
        ...
        public WebDav(HttpClient httpClient)
        {
        ...
        /// <returns>This instance of <see cref="WebDav" /> to support chain calls.</returns>
        internal WebDav SetWebDavDispatcher(IWebDavDispatcher dispatcher)
        {
        ...
        /// <returns>This instance of <see cref="WebDav" /> to support chain calls.</returns>
        internal WebDav SetPropfindResponseParser(IResponseParser<PropfindResponse> responseParser)
        {
        ...
        /// <returns>This instance of <see cref="WebDav" /> to support chain calls.</returns>
        internal WebDav SetProppatchResponseParser(IResponseParser<ProppatchResponse> responseParser)
        {
            Guard.NotNull(responseParser, "responseParser");
        ...
        /// <returns>This instance of <see cref="WebDav" /> to support chain calls.</returns>
        internal WebDav SetLockResponseParser(IResponseParser<LockResponse> responseParser)
        {
            Guard.NotNull(responseParser, "responseParser");
